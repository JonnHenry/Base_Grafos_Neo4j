    ...
    .then(movies => {
      ...
      if (movies) {
        movies.forEach(movie => {
          $("<tr><td class='movie'>" + movie.title + "</td><td>" + movie.released + "</td><td>" + movie.tagline + '<td><button class="btn btn-info">Actualizar</button></td>' +'<td><button type="button" class="btn btn-warning">Eliminar</button></td></tr>').appendTo(t)
            .click(function() {
